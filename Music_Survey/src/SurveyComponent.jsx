  ...
  useEffect(() => {
    ...
    survey.onComplete.add(() => {
      ...
      const values = {
        ...
        Part_1: {
          Q1: {
            Time_img: pageTimeSpent.current.page3,
          ...
          Q2: {
            Time_img: pageTimeSpent.current.page9,
          ...
          Q3: {
            Time_img: pageTimeSpent.current.page15,
        ...
        Part_2: {
          Q1: {
            Time_img: pageTimeSpent.current.page21,
          ...
          Q2: {
            Time_img: pageTimeSpent.current.page27,
          ...
          Q3: {
            Time_img: pageTimeSpent.current.page33,
        ...
        Part_3: {
          Q1: {
            Time_img: pageTimeSpent.current.page39,
          ...
          Q2: {
            Time_img: pageTimeSpent.current.page45,
          ...
          Q3: {
            Time_img: pageTimeSpent.current.page51,
